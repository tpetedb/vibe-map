...
- The map is one you can use: tap a plot to walk there, make it bigger with its own button (or a long press on a phone), and every stop is a labelled button under it for a keyboard or a screen reader.
