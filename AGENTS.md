...
| `docs/` | `MAINTAINERS.md` (the zones and how a change travels), `CONFIG.md` (the three configuration levels), `SYLLABUS.md` (the course), `ROADMAP.md` (generated), `RESOURCES.md` (curated links), `AOE-STUDY.md` (what sokrypton/aoe taught us), `TOPICS.md` (how to write a topic of the tech tree), `SECURITY-MODEL.md` (what is trusted, what is not, and the one helper per sink). |
