...
**Imperial Age (Senior).** The AI harness. You stop typing code and start directing agents, with guardrails you wrote. [[LLM versus harness]], [[Context window and prompts]], [[Your harness - AGENTS.md, CLAUDE.md, dotfiles for agents]], [[AGENTS.md]], [[Skills (Agent Skills standard)]], [[Hooks]], [[MCP (Model Context Protocol)]], [[Subagents and multi-agent]], [[Headless agents and scheduling]], [[Tests and evals]], [[Security and permissions]], [[Cost, tokens and model choice]], [[Architecture decision records]]
