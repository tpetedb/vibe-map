...
- Stop 2 A terminal you enjoy: Ghostty, zsh, starship, fzf, ripgrep, bat, eza, and Tom's configs  [Ghostty](https://ghostty.org) · [Tom's dotfiles on GitHub](https://github.com/YOUR-USER/dotfiles) · [starship](https://starship.rs) · [fzf](https://github.com/junegunn/fzf) · [ripgrep](https://github.com/BurntSushi/ripgrep)
...
- Stop 8 Your dotfiles repo: Everything you configured tonight, versioned, so the next Mac is ten minutes  [Tom's dotfiles on GitHub](https://github.com/YOUR-USER/dotfiles) · [GitHub: dotfiles guide](https://dotfiles.github.io) · [Homebrew Bundle](https://docs.brew.sh/Brew-Bundle-and-Brewfile)
