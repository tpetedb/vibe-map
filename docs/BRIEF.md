...
- Fable steers, and since 21 September 2026 Fable agents also play, test, review and fix: overall usage with Opus agents in the mix was higher than with Fable alone. Keep the agents aligned with this document and with a dependency plan so that parallel work does not overwrite itself.
