...
| [0018](0018-shared-memory.md) | The teams share one board room and one memory, read by one command at session start | Accepted, 2026-09-24; the memory half superseded by DECISION #193 section 4 |
