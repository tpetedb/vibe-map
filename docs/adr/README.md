...
Next number: 0015. 0011 and 0012 were reserved for work that did not land and are never reused: a number names one decision, forever. The form: https://cognitect.com/blog/2011/11/15/documenting-architecture-decisions
