...
**Try in five minutes.** Take a small diff, your own last commit or git show HEAD in any repository. Write review.md with at least one comment under each of Design:, Tests: and Nit:, then end it with a line that starts Verdict: and says LGTM, or what has to change first.
