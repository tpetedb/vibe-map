- An artifact ring now shows whole on a finished island, where a delivered stop's slab used to cut it in half, and the mountain's ring runs round its foot instead of under its corners.
