...
T = [
    ...
    (
        ...
        ["zsh", "dotfiles", "justfile", "docker", "hooks"],
    ),
    (
        "zsh",
        "dark",
    ...
    (
        ...
        "just is written in Rust by Casey Rodarmor, with a syntax the manual says is inspired by make. It reached 1.0.0 on 22 February 2022 and has kept one changelog since. Modules (`mod`) arrived in 1.19.0 and were stabilised in 1.31.0, which is why older justfiles use `import` for everything.",
        "just --list in this repository, then just --dump --dump-format json | head -30 to see your own tasks as data. Add a recipe with a doc comment and a parameter, and run it.",
        [
            ("just manual", "https://just.systems/man/en/"),
            ("just, the repository", "https://github.com/casey/just"),
            (
                "Source: just manual, Recipes",
                "https://just.systems/man/en/recipes.html",
            ),
            (
                "Source: just manual, Documentation Comments",
                "https://just.systems/man/en/documentation-comments.html",
            ),
            (
                "Source: just manual, Recipe Parameters",
                "https://just.systems/man/en/recipe-parameters.html",
            ),
            (
                "Source: just manual, Dependencies",
                "https://just.systems/man/en/dependencies.html",
            ),
            (
                "Source: just manual, Dotenv Settings",
                "https://just.systems/man/en/dotenv-settings.html",
            ),
            (
                "Source: just manual, Shebang Recipes",
                "https://just.systems/man/en/shebang-recipes.html",
            ),
            (
                "Source: just manual, Attributes",
                "https://just.systems/man/en/attributes.html",
            ),
            (
                "Source: just manual, Imports",
                "https://just.systems/man/en/imports.html",
            ),
            (
                "Source: just manual, Modules",
                "https://just.systems/man/en/modules.html",
            ),
            (
                "Source: just manual, Listing Available Recipes",
                "https://just.systems/man/en/listing-available-recipes.html",
            ),
            (
                "Source: just manual, Formatting and dumping justfiles",
                "https://just.systems/man/en/formatting-and-dumping-justfiles.html",
            ),
            (
                "Source: just manual, Shell Completion Scripts",
                "https://just.systems/man/en/shell-completion-scripts.html",
            ),
            (
                "Source: just CHANGELOG (1.0.0, 22 February 2022)",
    ...
    (
        ...
        "In Claude Code type `/help`, then `!uv run vibe status`, then `@config/camp.toml what does the pet table do`. Open `CLAUDE.md` and see the `@AGENTS.md` import at the top. Then open the vault in Obsidian and click a `#tech` tag.",
        [
            (
